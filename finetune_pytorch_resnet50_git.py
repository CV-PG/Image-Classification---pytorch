...
print("create train-test folders")

TRAIN_RATIO = 0.9

Root = "set parent root/"
data_dir = os.path.join(Root, 'set data root which contains "images" folder')
images_dir = os.path.join(data_dir, 'images')
train_dir = os.path.join(data_dir, 'train')
test_dir = os.path.join(data_dir, 'test')

##---------this part should be run once to create train and test folder ---------##
...
print("load our data with our transforms....")
...
####################################################################################
############# create the iterators with the largest batch size that fits on our GPU
...
#####################################################################
##################### finetuning Resnet50 ###############
print("finetuning Resnet50 for all classes data....")

pretrained_model = models.resnet50(pretrained = True)
#pretrained_model = models.resnet152(pretrained = True)
####Our dataset, has 254 classes, so we first create a new linear layer with the required dimensions.
IN_FEATURES = pretrained_model.fc.in_features 
OUTPUT_DIM = len(test_data.classes)

fc = nn.Linear(IN_FEATURES, OUTPUT_DIM)

#### we replace the pre-trained model's linear layer with our own, randomly initialized linear layer.
...
print("define the learning rate finder class") 
...
####### define a function to plot the results of the range test #############
